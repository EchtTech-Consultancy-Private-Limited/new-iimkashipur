...
return new class extends Migration
{
    ...
    {
        Schema::create('social_media_enbed', function (Blueprint $table) {
            $table->uuid('uid')->primary();
            $table->string('youtube',355)->nullable();
            $table->string('linkedin',355)->nullable();
            $table->string('facebook',355)->nullable();
            $table->string('twitter',355)->nullable();
            $table->string('instagram',355)->nullable();
    ...
    {
        Schema::dropIfExists('social_media_enbed');
    }
};
