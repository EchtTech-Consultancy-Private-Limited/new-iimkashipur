...
return new class extends Migration
{
    ...
    public function up()
    {
        // Schema::create('home_page_sections_designs', function (Blueprint $table) {
        ...
        // });
        Schema::create('home_page_sections_designs_details', function (Blueprint $table) {
            $table->Uuid('uid')->primary();
            $table->Uuid('hpsi_id')->nullable(false);
            $table->JSON('content_en');
            $table->JSON('content_hi');
            $table->boolean('asset_type_id')->index()->default(0);
            $table->string('url',255)->nullable();
            $table->boolean('sort_order')->nullable()->default(0);
            $table->longtext('public_url')->nullable();
            $table->longtext('private_url')->nullable();
        ...
        Schema::create('home_page_sections_list', function (Blueprint $table) {
            $table->Uuid('uid')->primary();
            $table->string('title_en',255)->index()->nullable();
            $table->string('title_hi',255)->index()->nullable();
            $table->string('url',255)->nullable();
    ...
    {
        Schema::dropIfExists('home_page_sections_designs');
        Schema::dropIfExists('home_page_sections_designs_details');
        Schema::dropIfExists('home_page_sections_list');
    }
};
